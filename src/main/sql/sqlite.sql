...
CREATE VIEW fornitoriEnoteche
as
select * from fornitore join enoteca
where fornitore.ID = enoteca.ID;
CREATE VIEW fornitoriRappresentanti
as
select * from fornitore join rappresentante
where fornitore.ID = rappresentante.ID;
